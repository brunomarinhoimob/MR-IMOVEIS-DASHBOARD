# ---------------------------------------------------------
# ABA - CLIENTES EM ANÁLISE
# ---------------------------------------------------------
with tab_clientes_analise:
    # Cabeçalho com logo MR
    col_logo, col_titulo = st.columns([1, 4])
    with col_logo:
        # Arquivo correto: logo_mr.png
        try:
    ...
    if df.empty:
        st.info("A base ainda está vazia. Não há registros para exibir.")
    else:
        ...
        if "CLIENTE" in df.columns:
            ...
            st.error(
                "Não encontrei a coluna de cliente (CLIENTE ou NOME_CLIENTE). "
